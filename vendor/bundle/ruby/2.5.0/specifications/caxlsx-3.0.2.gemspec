...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<nokogiri>.freeze, [">= 1.10.4", "~> 1.10"])
      s.add_runtime_dependency(%q<rubyzip>.freeze, ["< 3", ">= 1.3.0"])
      ...
      s.add_dependency(%q<nokogiri>.freeze, [">= 1.10.4", "~> 1.10"])
      s.add_dependency(%q<rubyzip>.freeze, ["< 3", ">= 1.3.0"])
