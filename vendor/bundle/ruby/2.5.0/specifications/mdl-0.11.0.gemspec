...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<mixlib-cli>.freeze, [">= 2.1.1", "~> 2.1"])
      s.add_runtime_dependency(%q<mixlib-config>.freeze, ["< 4", ">= 2.2.1"])
      s.add_runtime_dependency(%q<mixlib-shellout>.freeze, [">= 0"])
      s.add_development_dependency(%q<bundler>.freeze, ["< 3", ">= 1.12"])
      s.add_development_dependency(%q<minitest>.freeze, ["~> 5.9"])
      s.add_development_dependency(%q<pry>.freeze, ["~> 0.10"])
      s.add_development_dependency(%q<rake>.freeze, ["< 14", ">= 11.2"])
      ...
      s.add_dependency(%q<mixlib-cli>.freeze, [">= 2.1.1", "~> 2.1"])
      s.add_dependency(%q<mixlib-config>.freeze, ["< 4", ">= 2.2.1"])
      s.add_dependency(%q<mixlib-shellout>.freeze, [">= 0"])
      s.add_dependency(%q<bundler>.freeze, ["< 3", ">= 1.12"])
      s.add_dependency(%q<minitest>.freeze, ["~> 5.9"])
      s.add_dependency(%q<pry>.freeze, ["~> 0.10"])
      s.add_dependency(%q<rake>.freeze, ["< 14", ">= 11.2"])
